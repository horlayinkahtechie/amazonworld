      ...
      <main className="max-w-7xl mx-auto px-6 py-12">
        <div className="mb-10">
          ...
          <p className="text-gray-500">
            Shop now and get exclusive discounts and deals on your favourite
            products.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {products.map((product) => (
            ...
            >
              ...
              {/* Quick View Button */}
              <button className="mt-4 w-full cursor-pointer bg-gray-900 text-white py-2 rounded-lg font-medium opacity-0 group-hover:opacity-100 transition-all duration-300 transform translate-y-2 group-hover:translate-y-0">
                View Details
              </button>
            </div>
          ))}
